...
export const LinesAndWrinklesPageComponent: CollectionConfig = {
  slug: 'lines-wrinkles-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Lines & Wrinkles Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Dr Young with working with patient',
            },
          ],
        },
      ],
    ...
    // Half Image Section 1
    {
      ...
      type: 'group',
      label: 'Half Image Section 1 (Why Lines Happen)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Before & After Section
    {
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            description: 'Drag to reorder patient before/after images',
          },
          fields: [
            {
              name: 'image',
    ...
    // Banner Section 1 (Goldfingers Difference)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (Goldfingers Difference)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Box Grid Section 1 (Cheeks, Chin, Jawline)
    {
      name: 'boxGridSection1',
      type: 'group',
      label: 'Box Grid Section 1 (Cheeks, Chin, Jawline)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Banner Section 2 (Laugh Lines, Frown Lines)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (Laugh Lines, Frown Lines)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Box Grid Section 2 (Favorite Injectables)
    {
      name: 'boxGridSection2',
      type: 'group',
      label: 'Box Grid Section 2 (Favorite Injectables)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section (Aspire Rewards)
    {
      name: 'columnSection',
      type: 'group',
      label: 'Column Section (Aspire Rewards)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Half Image Section 1 (Why Lines Happen)', value: 'halfImageSection1' },
            { label: 'Before & After Section', value: 'beforeAfter' },
            { label: 'Banner Section 1 (Goldfingers Difference)', value: 'bannerSection1' },
            { label: 'Box Grid Section 1 (Cheeks, Chin, Jawline)', value: 'boxGridSection1' },
            { label: 'Banner Section 2 (Laugh Lines, Frown Lines)', value: 'bannerSection2' },
            { label: 'Box Grid Section 2 (Favorite Injectables)', value: 'boxGridSection2' },
            { label: 'Column Section (Aspire Rewards)', value: 'columnSection' },
          ],
        },
      ],
      defaultValue: [
