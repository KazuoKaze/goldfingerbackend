...
export const DiamondGlowPageComponent: CollectionConfig = {
  slug: 'diamondglow-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'DiamondGlow Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Woman touching her face and smiling',
            },
          ],
        },
      ],
    ...
    // Two Column Section 1 (What is DiamondGlow?)
    {
      name: 'twoColumnSection1',
      type: 'group',
      label: 'Two Column Section 1 (What is DiamondGlow)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'What is DiamondGlow?',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Banner Section 1 (What are the benefits)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (Benefits)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'What are the benefits of DiamondGlow?',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Half Image Section (Who is a candidate)
    {
      name: 'halfImageSection',
      type: 'group',
      label: 'Half Image Section (Candidate)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 1 (Treatment Process)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (Treatment Process)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'What is the treatment process like?',
        },
        {
          name: 'headingColor',
          type: 'text',
        ...
        },
        {
          ...
          label: 'Left Column Content',
          admin: {
            condition: (data) => data.layoutType === 'two-columns',
          },
        },
        {
          name: 'rightColumnContent',
    ...
    // Banner Section 2 (Recovery and Results)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (Recovery & Results)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 2 (Why choose Goldfinger)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Why Choose Us)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Why choose Goldfinger Aesthetics?',
        },
        {
          name: 'headingColor',
          type: 'text',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Two Column Section 1 (What is DiamondGlow)', value: 'twoColumnSection1' },
            { label: 'Banner Section 1 (Benefits)', value: 'bannerSection1' },
            { label: 'Half Image Section (Candidate)', value: 'halfImageSection' },
            { label: 'Column Section 1 (Treatment Process)', value: 'columnSection1' },
            { label: 'Banner Section 2 (Recovery & Results)', value: 'bannerSection2' },
            { label: 'Column Section 2 (Why Choose Us)', value: 'columnSection2' },
          ],
        },
      ],
      defaultValue: [
