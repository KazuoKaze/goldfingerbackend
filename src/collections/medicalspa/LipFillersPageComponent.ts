...
export const LipFillersPageComponent: CollectionConfig = {
  slug: 'lip-fillers-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Lip Fillers Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Doctor going over file with patient',
            },
          ],
        },
      ],
    ...
    // Intro Section
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'The Secret to Fuller, Softer, More Defined Lips',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Banner Section 1 (Transform Your Appearance)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (Transform Your Appearance)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 1 (Tailored Lip Injections)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (Tailored Lip Injections)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // CTA General Section (Schedule a Consultation)
    {
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Link Text',
              defaultValue: 'View More Lip Fillers Results',
            },
            {
              name: 'url',
              type: 'text',
              label: 'Link URL',
              defaultValue: '/gallery/non-surgical/lip-fillers/',
            },
            {
              name: 'ariaLabel',
              type: 'text',
    ...
    // Column Section 2 (Which Lip Filler)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Which Lip Filler)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Half Image Section (Get The Lips You Love)
    {
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Banner Section 1 (Transform)', value: 'bannerSection1' },
            { label: 'Column Section 1 (Tailored)', value: 'columnSection1' },
            { label: 'CTA General Section', value: 'ctaGeneralSection' },
            { label: 'CTA Before & After Section', value: 'ctaBeforeAfterSection' },
            { label: 'Column Section 2 (Which Filler)', value: 'columnSection2' },
