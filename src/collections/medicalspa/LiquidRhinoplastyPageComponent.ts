...
export const LiquidRhinoplastyPageComponent: CollectionConfig = {
  slug: 'liquid-rhinoplasty-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Liquid Rhinoplasty Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          required: true,
          defaultValue: 'Liquid (Non-Surgical) Rhinoplasty',
        },
        {
          name: 'titleColor',
          type: 'text',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: "Woman's side profile",
            },
          ],
        },
      ],
    ...
    // CTA Before & After Section
    {
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            description: 'Add before/after images',
          },
          fields: [
            {
              name: 'image',
    ...
    // Banner Section (What is Liquid Rhinoplasty)
    {
      name: 'bannerSection',
      type: 'group',
