...
export const DowntownTampaPageComponent: CollectionConfig = {
  slug: 'downtown-tampa-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Downtown Tampa Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
