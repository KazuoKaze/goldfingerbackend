...
export const BotoxPageComponent: CollectionConfig = {
  slug: 'botox-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'BOTOX Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
    ...
    // Column Section 1 (Who Benefits)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (Who Benefits)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Banner Section 1 (Benefits of BOTOX)
    {
      name: 'bannerSection1',
      type: 'group',
    ...
    // Half Image Section (Dysport)
    {
      name: 'halfImageSection',
      type: 'group',
      label: 'Half Image Section (Dysport)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Banner Section 2 (Advanced Techniques)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (Advanced Techniques)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 2 (Treatment Experience)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Treatment Experience)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 3 (How Long Will It Work)
    {
      name: 'columnSection3',
      type: 'group',
      label: 'Column Section 3 (How Long)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Banner Section 3 (Why Choose Us)
    {
      name: 'bannerSection3',
      type: 'group',
      label: 'Banner Section 3 (Why Choose Us)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 4 (Locations)
    {
      name: 'columnSection4',
      type: 'group',
      label: 'Column Section 4 (Locations)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          admin: {
            description: 'Drag to reorder location links',
          },
          fields: [
            {
              name: 'label',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Column Section 1 (Who Benefits)', value: 'columnSection1' },
            { label: 'Banner Section 1 (Benefits)', value: 'bannerSection1' },
            { label: 'Video Section', value: 'videoSection' },
            { label: 'Half Image Section (Dysport)', value: 'halfImageSection' },
            { label: 'Banner Section 2 (Advanced Techniques)', value: 'bannerSection2' },
            { label: 'Column Section 2 (Treatment Experience)', value: 'columnSection2' },
            { label: 'CTA General Section', value: 'ctaGeneralSection' },
            { label: 'Column Section 3 (How Long)', value: 'columnSection3' },
            { label: 'Banner Section 3 (Why Choose Us)', value: 'bannerSection3' },
            { label: 'Column Section 4 (Locations)', value: 'columnSection4' },
