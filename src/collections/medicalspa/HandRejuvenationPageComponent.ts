...
export const HandRejuvenationPageComponent: CollectionConfig = {
  slug: 'hand-rejuvenation-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Hand Rejuvenation Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          required: true,
          defaultValue: 'Hand Rejuvenation',
        },
        {
          name: 'titleColor',
          type: 'text',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Doctor going over chart with patient',
            },
          ],
        },
      ],
    ...
    // Intro Section
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: "Don't Let Your Hands Give Away Your Age!",
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Banner Section 1 (What Is Hand Rejuvenation)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (What Is Hand Rejuvenation)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'What Is Hand Rejuvenation?',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Column Section 1 (How Does It Work)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (How Does It Work)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          defaultValue: '30',
          admin: {
            description: 'Numeric value (e.g., 30 for mt-30)',
          },
        },
        {
          name: 'marginBottom',
          ...
          defaultValue: '30',
          admin: {
            description: 'Numeric value (e.g., 30 for mb-30)',
          },
        },
      ],
    },
    // Half Image Section (Benefits)
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Benefits Of Hand Rejuvenation With Dermal Filler',
        },
        {
          name: 'headingColor',
          type: 'text',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Brunette woman smiling',
            },
          ],
        },
        {
    ...
    // Box Grid Section (Candidates)
    {
      name: 'boxGridSection',
      type: 'group',
      label: 'Box Grid Section (Candidates)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Candidates For Hand Rejuvenation',
        },
        {
          name: 'headingColor',
          type: 'text',
        ...
        },
        {
          ...
          defaultValue: '20',
          admin: {
            description: 'Numeric value (e.g., 20 for pt-20)',
          },
        },
      ],
    },
    // Column Section 2 (What To Expect In Recovery)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Recovery)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'What To Expect In Recovery',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Banner Section 2 (Why Choose Us)
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Say Goodbye To Dry, Wrinkled Hands With Goldfingers Rejuvenation Services',
        },
        {
          name: 'headingColor',
          type: 'text',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Banner Section 1 (What Is Hand Rejuvenation)', value: 'bannerSection1' },
            { label: 'Column Section 1 (How Does It Work)', value: 'columnSection1' },
            { label: 'Half Image Section (Benefits)', value: 'halfImageSection' },
            { label: 'Box Grid Section (Candidates)', value: 'boxGridSection' },
      ...
      fields: [
        {
          ...
          type: 'text',
          label: 'Meta Title',
          defaultValue: 'Hand Rejuvenation - Goldfingers Aesthetics',
        },
        {
