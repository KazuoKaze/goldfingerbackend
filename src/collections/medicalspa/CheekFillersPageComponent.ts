...
export const CheekFillersPageComponent: CollectionConfig = {
  slug: 'cheek-fillers-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Cheek Fillers Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Dr Young with patient',
            },
          ],
        },
      ],
    ...
    // Banner Section 1 (Elegant Enhancement)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (Elegant Enhancement)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Box Grid Section (Filler Types)
    {
      name: 'boxGridSection',
      type: 'group',
      label: 'Box Grid Section (Filler Types)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Banner Section 2 (Why Choose Us)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (Why Choose Us)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Two Column Section (Clinical Experience)
    {
      name: 'twoColumnSection',
      type: 'group',
      label: 'Two Column Section (Clinical Experience)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Half Image Section (Tailored Approach)
    {
      name: 'halfImageSection',
      type: 'group',
      label: 'Half Image Section (Tailored Approach)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Banner Section 1 (Elegant Enhancement)', value: 'bannerSection1' },
            { label: 'Box Grid Section (Filler Types)', value: 'boxGrid' },
            { label: 'Banner Section 2 (Why Choose Us)', value: 'bannerSection2' },
            { label: 'Two Column Section (Clinical Experience)', value: 'twoColumn' },
            { label: 'Half Image Section (Tailored Approach)', value: 'halfImage' },
          ],
        },
      ],
      defaultValue: [
