...
export const ClermontPageComponent: CollectionConfig = {
  slug: 'clermont-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Clermont Location Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Park in Clermont, FL',
            },
          ],
        },
      ],
    },
    // Experience Section (Column Module)
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Padding Top',
          admin: {
            description: 'CSS value (e.g., 30px, 2rem)',
          },
        },
        {
          name: 'paddingBottom',
    ...
    // Path to Beauty Banner Section
    {
      name: 'pathToBannerSection',
      type: 'group',
      label: 'Path to Beauty Banner Section',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          maxRows: 2,
          admin: {
            description: 'Add up to 2 columns of content',
          },
          fields: [
            {
              name: 'heading',
    ...
    // Personalized Care Section
    {
      ...
      type: 'group',
      label: 'Personalized Care Section',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Goldfingers Way Banner Section
    {
      name: 'goldfingersWayBannerSection',
      type: 'group',
      label: 'Goldfingers Way Banner Section',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          type: 'text',
          label: 'Additional CSS Classes',
          defaultValue: 'dark hide-divider viewport background-14',
        },
        {
          name: 'backgroundImage',
          type: 'group',
    ...
    // Non-Surgical Enhancements Section (Column with Media)
    {
      name: 'nonSurgicalEnhancementsSection',
      type: 'group',
    ...
    {
      name: 'goldfingersStoryBannerSection',
      type: 'group',
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          label: 'Additional CSS Classes',
          defaultValue: 'dark hide-divider viewport background-3',
        },
        {
          name: 'backgroundImage',
          type: 'group',
    ...
    // Refresh Renew Restore Section (Half Image)
    {
      name: 'refreshRenewRestoreSection',
      type: 'group',
      label: 'Refresh Renew Restore Section',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'crane on beach at sunset',
            },
          ],
        },
      ],
    },
    // Plastic Surgery Services Section
    {
      name: 'plasticSurgeryServicesSection',
      type: 'group',
      label: 'Plastic Surgery Services Section',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Experience Goldfingers Banner Section
    {
      name: 'experienceGoldfingersBannerSection',
      type: 'group',
      label: 'Experience Goldfingers Banner Section',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Section Order
    {
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Experience Section', value: 'experience' },
            { label: 'Path to Beauty Banner', value: 'pathToBanner' },
            { label: 'Personalized Care', value: 'personalizedCare' },
            { label: 'Goldfingers Way Banner', value: 'goldfingersWayBanner' },
            { label: 'Non-Surgical Enhancements', value: 'nonSurgicalEnhancements' },
            { label: 'Goldfingers Story Banner', value: 'goldfingersStoryBanner' },
            { label: 'Refresh Renew Restore', value: 'refreshRenewRestore' },
            { label: 'Plastic Surgery Services', value: 'plasticSurgeryServices' },
            { label: 'Experience Goldfingers Banner', value: 'experienceGoldfingersBanner' },
      ...
      defaultValue: [
        { section: 'hero' },
        { section: 'experience' },
        { section: 'pathToBanner' },
        { section: 'personalizedCare' },
        { section: 'goldfingersWayBanner' },
        { section: 'nonSurgicalEnhancements' },
        { section: 'goldfingersStoryBanner' },
        { section: 'refreshRenewRestore' },
        { section: 'plasticSurgeryServices' },
        { section: 'experienceGoldfingersBanner' },
        { section: 'whyChooseUs' },
      ],
    },
    // Global Styles
