...
export const DermalFillersPageComponent: CollectionConfig = {
  slug: 'dermal-fillers-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Dermal Fillers Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Doctor working with patient',
            },
          ],
        },
      ],
    ...
    // Banner Section 1 (Restore Your Youthful Radiance)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (Restore Radiance)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          type: 'text',
          label: 'Custom CSS Classes',
          defaultValue: 'dark hide-divider viewport wow fadeInUp',
        },
        {
          name: 'backgroundImage',
          type: 'group',
    ...
    // Column Section 1 (What Can Dermal Fillers Be Used For)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (Uses)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        {
          name: 'useVerticalAlign',
          type: 'checkbox',
          label: 'Use Vertical Alignment',
          defaultValue: true,
        },
        {
          name: 'useTwoColumns',
    ...
    // Half Image Section (Treatment Areas)
    {
      name: 'halfImageSection',
      type: 'group',
      label: 'Half Image Section (Treatment Areas)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          name: 'copyPadded',
          type: 'checkbox',
          label: 'Add Padding to Copy Area',
          defaultValue: true,
        },
        {
          name: 'heading',
        ...
        {
          name: 'treatmentAreaLinks',
          type: 'array',
          label: 'Treatment Area Links',
          admin: {
            description: 'Drag to reorder treatment area links',
          },
          fields: [
            {
              name: 'label',
        ...
        },
        {
          name: 'fillersList',
          type: 'array',
          label: 'Filler Products List',
          admin: {
            description: 'Drag to reorder filler products',
          },
          fields: [
            {
              name: 'name',
    ...
    // Box Grid Section (Why Choose Goldfingers)
    {
      name: 'boxGridSection',
      type: 'group',
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          label: 'Custom CSS Classes',
          defaultValue: 'five-boxes option-1 default bkg-image dark wider',
        },
        {
          name: 'headingBefore',
          type: 'text',
    ...
    // Column Section 2 (Facial Contouring)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Facial Contouring)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Banner Section 2 (Discover the Artistry)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (Artistry)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Banner Section 1 (Restore Radiance)', value: 'bannerSection1' },
            { label: 'Column Section 1 (Uses)', value: 'columnSection1' },
            { label: 'Half Image Section (Treatment Areas)', value: 'halfImageSection' },
            { label: 'Box Grid Section (Why Choose Us)', value: 'boxGridSection' },
            { label: 'Column Section 2 (Facial Contouring)', value: 'columnSection2' },
            { label: 'Banner Section 2 (Artistry)', value: 'bannerSection2' },
      ...
      fields: [
        {
          name: 'useColumnsLayout',
          type: 'checkbox',
          label: 'Use Columns Layout for Lists',
          defaultValue: true,
        },
        {
          name: 'columnCount',
          ...
          admin: {
            description: 'Number of columns for list items',
          },
          defaultValue: 2,
        },
        {
