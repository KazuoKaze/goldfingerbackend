...
export const NonSurgicalGalleryComponent: CollectionConfig = {
  slug: 'non-surgical-gallery-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Non-Surgical Gallery Component',
    },
    {
      name: 'sections',
      type: 'array',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Sub-Index Section', value: 'subIndex' },
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'text',
              required: true,
              defaultValue: 'Non-Surgical Gallery',
              label: 'Page Title',
            },
            {
              name: 'titleColor',
        ...
        {
          name: 'subIndexSection',
          type: 'group',
          label: 'Sub-Index Section Settings',
          admin: {
            condition: (data, siblingData) => siblingData?.sectionType === 'subIndex',
          },
          fields: [
            {
              name: 'backgroundColor',
              ...
              fields: [
                {
                  ...
                  label: 'Category Name',
                  admin: {
                    description: 'Display name for the category (e.g., Lip Fillers)',
                  },
                },
                {
                  name: 'categorySlug',
                  ...
                  admin: {
                    description: 'URL-friendly slug and CSS class (e.g., lip-fillers)',
                  },
                },
                {
                  name: 'url',
