...
export const JuvedermVoluxPageComponent: CollectionConfig = {
  slug: 'juvederm-volux-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'JUVÉDERM VOLUX Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          required: true,
          defaultValue: 'JUVÉDERM® VOLUX® XC',
        },
        {
          name: 'titleColor',
          type: 'text',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'doctor working with patient in chair',
            },
          ],
        },
      ],
    ...
    // Banner Section 1 (How Does It Work)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (How Does It Work)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          admin: {
            description: 'Add content columns for two-column layout',
          },
          fields: [
            {
              name: 'content',
    ...
    // Column Section 1 (Why Choose Goldfingers)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (Why Choose Goldfingers)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          name: 'introContent',
          type: 'richText',
          label: 'Intro Content (Before Bullet Points)',
        },
        {
          name: 'bulletPoints',
          type: 'array',
        ...
        },
        {
          name: 'closingContent',
          type: 'richText',
          label: 'Closing Content (After Bullet Points)',
        },
        {
          name: 'marginTop',
          type: 'text',
          label: 'Margin Top',
          admin: {
            description: 'CSS margin-top value (e.g., 30px, 2rem)',
          },
        },
        {
          name: 'marginBottom',
          ...
          label: 'Margin Bottom',
          admin: {
            description: 'CSS margin-bottom value (e.g., 30px, 2rem)',
          },
        },
      ],
    },
    // CTA General Section
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Margin Top',
          admin: {
            description: 'CSS margin-top value (e.g., 0, 30px)',
          },
        },
        {
          name: 'marginBottom',
          ...
          label: 'Margin Bottom',
          admin: {
            description: 'CSS margin-bottom value (e.g., 0, 30px)',
          },
        },
      ],
    },
    // Half Image Section (Good Candidate)
    {
      name: 'halfImageSection',
      type: 'group',
      label: 'Half Image Section (Good Candidate)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          admin: {
            description: 'CSS margin-top value for desktop (e.g., 60px)',
          },
        },
        {
          ...
          admin: {
            description: 'CSS margin-top value for tablet (e.g., 40px)',
          },
        },
        {
          name: 'paddingTop',
          ...
          label: 'Padding Top',
          admin: {
            description: 'CSS padding-top value (e.g., 20px)',
          },
        },
      ],
    },
    // Column Section 2 (Candidate Assessment)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Candidate Assessment)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Banner Section 2 (What Happens During Procedure)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (What Happens During Procedure)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          name: 'introContent',
          type: 'richText',
          label: 'Intro Content (Before Columns)',
        },
        {
          name: 'columnLayout',
          type: 'select',
    ...
    // Two Column Section (Recovery and Results)
    {
      name: 'twoColumnSection',
      type: 'group',
      label: 'Two Column Section (Recovery and Results)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        {
          name: 'rightColumnColor',
          type: 'text',
          label: 'Right Column Text Color',
        },
        {
          name: 'verticalAlign',
          type: 'checkbox',
          label: 'Vertically Align Columns',
          defaultValue: false,
        },
        {
          name: 'marginTop',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Banner Section 1 (How Does It Work)', value: 'bannerSection1' },
            { label: 'Column Section 1 (Why Choose Goldfingers)', value: 'columnSection1' },
            { label: 'CTA General Section', value: 'ctaGeneralSection' },
            { label: 'Half Image Section (Good Candidate)', value: 'halfImageSection' },
            { label: 'Column Section 2 (Candidate Assessment)', value: 'columnSection2' },
            { label: 'Banner Section 2 (What Happens During Procedure)', value: 'bannerSection2' },
            { label: 'Two Column Section (Recovery and Results)', value: 'twoColumnSection' },
          ],
        },
      ],
      defaultValue: [
