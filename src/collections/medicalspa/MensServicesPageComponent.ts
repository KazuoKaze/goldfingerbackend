...
export const MensServicesPageComponent: CollectionConfig = {
  slug: 'mens-services-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: "Men's Services Page Component",
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Brunette man smiling',
            },
          ],
        },
      ],
    ...
    // Banner Section 1 (BOTOX)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (BOTOX)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 1 (Sculptra)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (Sculptra)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 2 (Non-Surgical Facelift)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Non-Surgical Facelift)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Half Image Section (Gentleman's Facial)
    {
      name: 'halfImageSection',
      type: 'group',
      label: "Half Image Section (Gentleman's Facial)",
      fields: [
        {
          name: 'show',
          type: 'checkbox',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Banner Section 1 (BOTOX)', value: 'bannerSection1' },
            { label: 'Column Section 1 (Sculptra)', value: 'columnSection1' },
            { label: 'Banner Section 2 (KYBELLA)', value: 'bannerSection2' },
            { label: 'Column Section 2 (Non-Surgical Facelift)', value: 'columnSection2' },
            { label: "Half Image Section (Gentleman's Facial)", value: 'halfImageSection' },
          ],
        },
      ],
      defaultValue: [
