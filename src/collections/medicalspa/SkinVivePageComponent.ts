...
export const SkinVivePageComponent: CollectionConfig = {
  slug: 'skinvive-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'SkinVive Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'close up of woman looking at camera',
            },
          ],
        },
      ],
    ...
    // Intro Section
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Revitalize your face with SkinVive',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Column Section 1 (What is SkinVive)
    {
      name: 'columnSection1',
      type: 'group',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'close up of pretty blonde woman',
            },
          ],
        },
      ],
    },
    // Banner Section (Benefits)
    {
      name: 'bannerSection',
      type: 'group',
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'What are the benefits of SkinVive?',
        },
        {
          name: 'headingColor',
          type: 'text',
        ...
        },
        {
          ...
          defaultValue: [
            {
              text: 'Delivers subtle yet remarkable enhancements in skin texture and volume, creating a naturally refreshed appearance',
            },
            {
              text: 'Serves as a surgery alternative, allowing patients to avoid the associated risks',
            },
            {
              text: 'Requires no downtime, enabling patients to resume their regular activities without delay',
            },
            {
              text: 'An adaptable treatment that can be tailored to address individual concerns and issues',
            },
            {
              text: 'Produces long-lasting results that can last up to nine months',
            },
          ],
          fields: [
            {
    ...
    // Half Image Section (Candidate)
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Who is a candidate for SkinVive?',
        },
        {
          name: 'headingColor',
          type: 'text',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Woman examining cheek',
            },
          ],
        },
      ],
    },
    // Box Grid Section (Procedure Details)
    {
      name: 'boxGridSection',
      type: 'group',
    ...
    // Office/Why Choose Us Section
    {
      name: 'officeSection',
      type: 'group',
      label: 'Office/Why Choose Us Section',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Why choose Goldfingers Aesthetics and Plastic Surgery and Skincare?',
        },
        {
          name: 'headingColor',
          type: 'text',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Goldfingers office waiting room',
            },
          ],
        },
      ],
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Column Section 1 (What is SkinVive)', value: 'columnSection1' },
            { label: 'Banner Section (Benefits)', value: 'banner' },
            { label: 'Half Image Section (Candidate)', value: 'halfImage' },
            { label: 'Box Grid Section (Procedure Details)', value: 'boxGrid' },
            { label: 'Office Section (Why Choose Us)', value: 'office' },
          ],
        },
      ],
      defaultValue: [
      ...
      fields: [
        {
          ...
          type: 'text',
          label: 'Meta Title',
          defaultValue: 'SkinVive - Goldfingers Aesthetics and Plastic Surgery',
        },
        {
          ...
          defaultValue:
            'A new treatment from Juvederm, SkinVive is a new solution for skin rejuvenation, empowering patients to address skin texture concerns and boost self-confidence.',
        },
        {
          name: 'ogImage',
          type: 'upload',
        ...
        },
        {
          ...
          defaultValue: 'SkinVive, Juvederm, skin rejuvenation, dermal fillers, Orlando',
        },
        {
          name: 'canonicalUrl',
          type: 'text',
          label: 'Canonical URL',
          defaultValue: '/medical-spa/skinvive/',
        },
        {
          name: 'robots',
          type: 'select',
