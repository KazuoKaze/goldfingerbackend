...
export const PermanentMakeupPageComponent: CollectionConfig = {
  slug: 'permanent-makeup-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Permanent Makeup Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Blonde woman with makeup',
            },
          ],
        },
      ],
    ...
    // Intro Section
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Flawless beauty, all day, every day',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Column Section 1 (The Permanent Makeup Experts)
    {
      name: 'columnSection1',
      type: 'group',
      label: 'Column Section 1 (Experts)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'The Permanent Makeup Experts',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Banner Section 1 (Simplify Your Beauty Routine)
    {
      name: 'bannerSection1',
      type: 'group',
      label: 'Banner Section 1 (Simplify Beauty Routine)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Simplify Your Beauty Routine With Goldfingers',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Column Section 2 (Upper and Lower Eyeliner)
    {
      name: 'columnSection2',
      type: 'group',
      label: 'Column Section 2 (Eyeliner)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Layout Type',
          options: [
            { label: 'Two Columns - Vertical Align', value: 'two-column' },
    ...
    // Column Section 3 (Microblading Brow Shaping)
    {
      name: 'columnSection3',
      type: 'group',
      label: 'Column Section 3 (Microblading)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Box Grid Section (Permanent Lip Liner)
    {
      name: 'boxGridSection',
      type: 'group',
      label: 'Box Grid Section (Lip Liner)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section 4 (Lip Blush)
    {
      name: 'columnSection4',
      type: 'group',
      label: 'Column Section 4 (Lip Blush)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Half Image Section (Eyelash Extensions)
    {
      name: 'halfImageSection',
      type: 'group',
      label: 'Half Image Section (Eyelash Extensions)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'Full, Beautiful Lashes With Eyelash Extensions',
        },
        {
          name: 'headingColor',
          type: 'text',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: "Woman's eyelid",
            },
          ],
        },
      ],
    },
    // Column Section 5 (Treatment Experience)
    {
      name: 'columnSection5',
      type: 'group',
      label: 'Column Section 5 (Treatment Experience)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'The Treatment Experience',
        },
        {
          name: 'headingColor',
          type: 'text',
    ...
    // Banner Section 2 (How Long Does Permanent Makeup Last)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (Duration)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          label: 'Heading',
          required: true,
          defaultValue: 'How Long Does Permanent Makeup Last?',
        },
        {
          name: 'headingColor',
          type: 'text',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Column Section 1 (Experts)', value: 'columnSection1' },
            { label: 'Banner Section 1 (Simplify Beauty)', value: 'bannerSection1' },
            { label: 'Column Section 2 (Eyeliner)', value: 'columnSection2' },
            { label: 'CTA General Section 1', value: 'ctaGeneralSection1' },
            { label: 'Column Section 3 (Microblading)', value: 'columnSection3' },
            { label: 'Box Grid Section (Lip Liner)', value: 'boxGridSection' },
            { label: 'Column Section 4 (Lip Blush)', value: 'columnSection4' },
            { label: 'Half Image Section (Eyelash)', value: 'halfImageSection' },
            { label: 'Column Section 5 (Treatment)', value: 'columnSection5' },
            { label: 'Banner Section 2 (Duration)', value: 'bannerSection2' },
          ],
        },
      ],
      defaultValue: [
