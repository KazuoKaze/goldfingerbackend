...
export const RestylanePageComponent: CollectionConfig = {
  slug: 'restylane-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Restylane Page Component',
    },
    // Hero Section
    {
      name: 'heroSection',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Alt Text',
              required: true,
              defaultValue: 'Woman receiving facial injection',
            },
          ],
        },
      ],
    ...
    // Half Image Section (Timeless Beauty)
    {
      name: 'halfImageSection',
      type: 'group',
      label: 'Half Image Section (Timeless Beauty)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Box Grid Section (Favorite Restylane Fillers)
    {
      name: 'boxGridSection',
      type: 'group',
      label: 'Box Grid Section (Favorite Fillers)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
    ...
    // Column Section (14 Locations)
    {
      name: 'columnSection',
      type: 'group',
      label: 'Column Section (Locations)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
        ...
        },
        {
          ...
          admin: {
            description: 'Drag to reorder location columns',
          },
          fields: [
            {
              name: 'locations',
              type: 'array',
              label: 'Locations in Column',
              fields: [
                {
                  name: 'name',
                  type: 'text',
    ...
    // Banner Section 2 (Perks & Rewards)
    {
      name: 'bannerSection2',
      type: 'group',
      label: 'Banner Section 2 (Perks & Rewards)',
      fields: [
        {
          name: 'show',
          type: 'checkbox',
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Half Image Section (Timeless Beauty)', value: 'halfImageSection' },
            { label: 'Banner Section 1 (Goldfingers Difference)', value: 'bannerSection1' },
            { label: 'Box Grid Section (Favorite Fillers)', value: 'boxGridSection' },
            { label: 'Column Section (Locations)', value: 'columnSection' },
            { label: 'Banner Section 2 (Perks & Rewards)', value: 'bannerSection2' },
          ],
        },
      ],
      defaultValue: [
